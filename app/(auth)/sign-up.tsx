  ...
  const onPressVerify = async () => {
    ...
    try {
      ...
      if (completeSignUp.status === 'complete') {
        //create a entry in our database when signin happens in clerk 
...
<ScrollView className=' flex-1 bg-white'>
  <View className='flex-1 bg-white'>
    ...
    >
      <View className='bg-white px-7 py-9 rounded-2xl m in-h-[300px]' >
     ...
     <ReactNativeModal isVisible={verification.state==="success"}>
      <View className='bg-white px-7 py-9 rounded-2xl min-h-[300px]'>
       ...
       <Text className='text-base text-gray-400 font-JakartaLight text-center mt-2'>You have successfully verified your account</Text>
